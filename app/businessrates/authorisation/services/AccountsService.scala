...
class AccountsService @Inject()(
  ...
  def get(externalId: String, groupId: String, enrolments: Enrolments)(implicit hc: HeaderCarrier): Future[Option[Accounts]] =
    for {
  ...
  def getBackendData(externalId: String, groupId: String)(implicit hc: HeaderCarrier): Future[Option[Accounts]] = (for {
